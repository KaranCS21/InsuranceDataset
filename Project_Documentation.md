...
This framing is accurate to what you built (a self-directed synthetic project demonstrating real technique) without overstating it as production analytics work — worth saying plainly in an interview that the dataset is synthetic but the modeling and workflow logic mirror your actual operational domain.
